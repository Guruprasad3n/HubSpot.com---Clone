    ...
    <Flex gap="1.5rem" w="95%" m="auto">
      <Box w="60%">
        ...
        <Text lineHeight={"27px"}>
          Sales software to help you attract the <br /> right audience, convert
      ...
      <Box>
        ...
        <Flex>
          <Box align="left">
            ...
            <Text mb="11px">
              {" "}
              <CheckIcon w="14px" /> Advanced CRM
            </Text>
            <Text mb="11px">
              {" "}
              <CheckIcon w="14px" /> Sales automation
            </Text>
            <Text mb="11px">
              {" "}
              <CheckIcon w="14px" /> eSignatures
            </Text>
            <Text mb="11px">
              {" "}
          ...
          <Box align="left">
            <Text mb="11px">
              {" "}
              <CheckIcon w="14px" /> Email sequences
            </Text>
            <Text mb="11px">
              {" "}
            ...
            <Text mb="11px">
              {" "}
              <CheckIcon w="14px" /> Customizable reports
            </Text>
            <Text mb="11px">
              {" "}
              <CheckIcon w="14px" /> Multiple deal pipelines
            </Text>
            <Text mb="11px">
              {" "}
